...
# Streamlit app
st.title("Comprehensive Tips Dataset Visualizations by Vinay")
st.write("This app displays a variety of Seaborn plots created by Vinay exploring the Tips dataset, which includes data on restaurant bills and tips.")
